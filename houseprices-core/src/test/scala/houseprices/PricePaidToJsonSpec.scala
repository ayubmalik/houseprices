...
class PricePaidToJsonSpec extends FlatSpec with Matchers {
  ...
  "HousePriceToJson" should "convert to json" in {
    ...
    PricePaidToJson(housePrice) should be(
      """{"id":"123","price":5000,"date":"2004","address":{"postcode":"pcode","primaryName":"p","secondaryName":"s","street":"st","locality":"l","townCity":"t","district":"d","county":"c","coords":{"lat":0.0,"lon":0.0}}}""")
  }
}